...
import MinSidebar from 'components/dashboard/sidebar/minSidebar'
import SpaceSidebarButtons from 'components/space/spaceSidebar/spaceSidebarButtons'
import { spaceById, isSpacesFetching } from 'components/space/spaceContainer/logic/spaceReducer'
import { MoonLoader } from 'react-spinners'
import BlogPagesList from 'components/blog/blogPagesList'
...
class BlogSidebar extends Component {
  render () {
    ...
    const color = space.spaceSettings ? space.spaceSettings.color : '#1c80ff'
