...
import { isPagesFetching } from 'components/page/logic/pageReducer'
import { spaceById } from 'components/space/spaceContainer/logic/spaceReducer'
import { getPageByIdRequest, deleteBlogPageRequest, sendMention, sendDocFileBlogRequest } from 'components/page/logic/pageActions'
import { bindActionCreators } from 'redux'

import CommentsList from 'components/commentsList'
import Like from 'components/common/like'
import {putLikeOnPageRequest, deleteLikeFromPageRequest, putLikeOnCommentRequest, deleteLikeFromCommentRequest} from 'components/page/likesLogic/likesAction'
import { AddComment } from 'components/comments/addComment'
import { MoonLoader } from 'react-spinners'

import {addCommentRequest, deleteCommentRequest, editCommentRequest} from 'components/page/commentsLogic/commentsActions'
import { addWatcherRequest, deleteWatcherRequest, addSpaceWatcherRequest, deleteSpaceWatcherRequest } from 'components/page/watcherLogic/watcherAction'

import { translate } from 'react-i18next'
import { withRouter } from 'react-router-dom'
import { openWarningModal, closeWarningModal } from 'components/modals/warningModal/logic/warningModalActions'
import fakeImg from 'resources/logo.svg'
import './blogPost.css'
